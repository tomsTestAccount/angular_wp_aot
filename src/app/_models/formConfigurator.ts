...
const sel_master_formEntries = [
     ...
     gridCells: [
	   ...
	   secParagraphArray: ["Bitte beachten Sie:","Markieren Sie den gewünschten Studiengang. Sie können mehrere der angebotenen Studiengänge auswählen, müssen aber Prioritäten festlegen.",
                          "Falls Sie für ein Masterstudium akzeptiert werden, erhalten Sie einen Zulassungsbescheid für den Studiengang, den Sie mit der höchsten Priorität gekennzeichnet haben und für den die Kommission Sie als geeignet begutachtet hat.",
